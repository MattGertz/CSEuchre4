...
namespace CSEuchre4
{
    public class EuchreCard
    {
        ...
        public static System.Drawing.Image[] imagesCardBack = new System.Drawing.Image[4];
        public static System.Drawing.Image[] imagesSuit = new System.Drawing.Image[4];
        #endregion
                ...
                for (EuchreCard.Suits NewSuit = EuchreCard.Suits.Spades; NewSuit <= EuchreCard.Suits.Hearts; NewSuit++)
                {
                    ...
                    for (EuchreCard.Ranks NewRank = EuchreCard.Ranks.Nine; NewRank <= EuchreCard.Ranks.Ace; NewRank++)
                    {
                        if (!(_ruleNineOfHeartsVariation && NewRank == EuchreCard.Ranks.Nine && NewSuit != EuchreCard.Suits.Hearts))
                        {
                            ...
                            _gameCards[n].imageCurrent = (System.Drawing.Image)Properties.Resources.ResourceManager.GetObject(_gameCards[n].GetImageResourceName());
                            n = n + 1;
                        }
                    }
                }
